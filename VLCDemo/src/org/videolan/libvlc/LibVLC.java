...
public class LibVLC {
    ...
    public int readMedia(String mrl, boolean novideo) {
        ...
        int ret = readMedia(mLibVlcInstance, mrl, novideo);
	return ret;
    }

    public int readMediaUdp(String mrl, boolean novideo) {
        Log.v(TAG, "Reading " + mrl);
        int ret = readMedia(mLibVlcInstance, mrl, novideo);
        setRtspOverTcp(false);
        setUseStun(false);
        return ret;
     }
    ...
    // added for stun
    /**
     * set rtsp over tcp flag
     */
    public int readMediaUseStun(String mrl, boolean novideo) {
        Log.v(TAG, "Using stun Reading " + mrl);
        int ret = readMedia(mLibVlcInstance, mrl, novideo);
        setRtspOverTcp(false);
        setUseStun(true);
        return ret;
    ...
    public int readMediaUdpNoStun(String mrl, boolean novideo) {
        Log.v(TAG, "Using udp Reading " + mrl);
        int ret = readMedia(mLibVlcInstance, mrl, novideo);
        setRtspOverTcp(false);
        setUseStun(false);
        return ret;
    ...
    public void setRtspOverTcp(boolean flag) {
    	setRtspOverTcp(mLibVlcInstance, flag);
    }
    
    private native void setRtspOverTcp(long instance, boolean flag);
    
    public void setStunServerPort(int stunPort) {
    	setStunServerPort(mLibVlcInstance, stunPort);
    }
    
    private native void setStunServerPort(long instance, int flag);
    
    public void setStunServerAddr(String addr) {
    	setStunServerAddr(mLibVlcInstance, addr);
    }
    
    private native void setStunServerAddr(long instance, String addr);    
     ...
     * set use stun flag
     */
    public void setUseStun(boolean flag) {
    	setUseStun(mLibVlcInstance, flag);
    }
    
    private native void setUseStun(long instance, boolean flag);
    // added for stun 
